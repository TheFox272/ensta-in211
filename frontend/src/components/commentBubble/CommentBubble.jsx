  ...
  return (
    <div className='comment-bubble'>
        ...
        <div className="upvote">
          <div className="upvote-number-anchor">
            <div className="upvote-number">4</div>
          </div>
        ...
        <div className="downvote">
          <div className="downvote-number-anchor">
            <div className="downvote-number">{comment.downvotes}</div>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
